## Generating function
Av1CondContIC <- function(name, CallL2Fam = call("L2RegTypeFamily"),
    ...
    return(new("Av1CondContIC", name = name, Curve = Curve, Risks = Risks, Infos = Infos,
...
setMethod("generateIC", signature(neighbor = "Av1CondContNeighborhood", 
...
## Access methods
setMethod("clip", "Av1CondContIC", function(object) object@clip)
setMethod("cent", "Av1CondContIC", function(object) object@cent)
setMethod("stand", "Av1CondContIC", function(object) object@stand)
setMethod("lowerCase", "Av1CondContIC", function(object) object@lowerCase)
setMethod("neighborRadius", "Av1CondContIC", function(object) object@neighborRadius)

## replace methods
setReplaceMethod("clip", "Av1CondContIC", 
    function(object, value){ 
        ...
        object <- generateIC(neighbor = Av1CondContNeighborhood(radius = object@neighborRadius), 
                             L2Fam = L2Fam, res = res)
...
setReplaceMethod("cent", "Av1CondContIC", 
    function(object, value){ 
...
setReplaceMethod("stand", "Av1CondContIC", 
    function(object, value){ 
...
setReplaceMethod("lowerCase", "Av1CondContIC", 
    function(object, value){ 
...
setReplaceMethod("neighborRadius", "Av1CondContIC", 
    function(object, value){ 
...
setReplaceMethod("CallL2Fam", "Av1CondContIC",
    function(object, value){ 
        L2Fam <- eval(value)
